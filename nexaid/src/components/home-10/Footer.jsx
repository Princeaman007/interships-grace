...
import FooterContent from "../footer/FooterContent4";
            ...
            <div className="big-column col-xl-3 col-lg-3 col-md-12">
              <div className="footer-column about-widget">
                <div className="logo">
                  <a href="#">
                    <img
                      ...
                      src="/images/logo-nexaid-interships-white-nexaid.svg"
                      alt="brand"
                    />
                  </a>
                </div>
                ...
                <p className="address">
                  ...
                  <a href="mailto:support@Nexaid Interships.com" className="email">
                    support@Nexaid Interships.com
                  </a>
                </p>
              </div>
            </div>
